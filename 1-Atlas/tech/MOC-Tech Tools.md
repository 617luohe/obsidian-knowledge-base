...
- [[my-skills v2 开发工作流技能体系]] — 全生命周期 Claude Code 技能链（v2：24 技能，三层架构）
- [[my-skills v2 深度分析报告]] — 📊 v2 24 技能体系架构深度分析 + v1→v2 迁移指南
- [[MOC-my-skills v2]] — 📖 v2 技能体系总索引
- [[my-skills vocabulary 核心层详解]] — 🔩 5 个可复用核心循环深度解析
...
- [[科研审批单自动生成工具]] — 报销单 PDF → 科研审批单 Excel 自动生成 CLI 工具
